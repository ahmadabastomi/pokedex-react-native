...
import { postPokemon } from '../../publics/redux/actions/pokemons'
...
class PokemonAdd extends Component {
    constructor(props) {
        ...
        this.state = {
            name: '',
            image_url: 'http://pedals.id/img/imageEmpty.png',
            category: 0,
            type1: 0,
            type2: 0,
            type3: 0,
    ...
    async addPokemon() {
        await this.props.dispatch(postPokemon({
...
export default connect(mapStateToProps)(PokemonAdd)
